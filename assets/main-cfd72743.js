...
const SnowboardList = ({ snowboards, onUpdateStatus, onUpdateName, onSave }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    snowboards.map((snowboard) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white p-4 rounded-lg shadow", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "select",
          {
            ...
            onChange: (e) => onUpdateStatus(snowboard.id, e.target.value),
            className: "px-3 py-1 border rounded",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "クリーニング前", children: "クリーニング前" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "クリーニング済み", children: "クリーニング済み" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "滑走ワックス済み", children: "滑走ワックス済み" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "滑走準備完了", children: "滑走準備完了" })
            ]
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 text-sm text-gray-600", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "最終更新: ",
        snowboard.updatedAt.toLocaleString()
      ] }) })
    ] }, snowboard.id)),
...
const STORAGE_KEY = "snowboard_manager_data";
const saveData = (data) => {
...
function App() {
  const [snowboards, setSnowboards] = reactExports.useState(() => {
  ...
  const [nextId, setNextId] = reactExports.useState(() => {
    const savedData = loadData();
    return (savedData == null ? void 0 : savedData.nextId) || 3;
  });
  ...
  const handleUpdateStatus = (id2, status) => {
    setSnowboards(
      (prev) => prev.map(
        (snowboard) => snowboard.id === id2 ? { ...snowboard, status, updatedAt: /* @__PURE__ */ new Date() } : snowboard
      )
    );
  };
  const handleUpdateName = (id2, name) => {
    setSnowboards(
      (prev) => prev.map(
        (snowboard) => snowboard.id === id2 ? { ...snowboard, name, updatedAt: /* @__PURE__ */ new Date() } : snowboard
      )
    );
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gray-100 p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold mb-8", children: "スノーボード管理アプリ" }),
